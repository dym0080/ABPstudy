...
(function () {
    ...
    abp.showLoading= function() {
        var pc = $('#layout-loading-progress');
        if (!pc) return;
        var pcb = $('#layout-loading-progress-bar');
        pcb.css('width', '0%');
        pc.show();
    }

    abp.hideLoading = function () {
        var pc = $('#layout-loading-progress');
        if (!pc) return;
        $('#layout-loading-progress-bar').css('width', '100%');
        $('#layout-loading-progress-bar').attr('data-action', 'stop');
        setTimeout(function () {
            pc.hide();
        },400);
    }
